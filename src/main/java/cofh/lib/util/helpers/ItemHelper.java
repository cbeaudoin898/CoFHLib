...
public final class ItemHelper {
	...
	public static boolean isPlayerHoldingMultiModeItemOffhand(EntityPlayer player) {

		Item equipped = player.getHeldItemOffhand() != null ? player.getHeldItemOffhand().getItem() : null;
		return equipped instanceof IMultiModeItem;
	}

	public static boolean incrHeldMultiModeItemStateOffhand(EntityPlayer player) {
	...
	public static boolean decrHeldMultiModeItemStateOffhand(EntityPlayer player) {
	...
	public static boolean setHeldMultiModeItemStateOffhand(EntityPlayer player, int mode) {
	...
	public static final boolean isPlayerHoldingFluidContainerOffhand(EntityPlayer player) {

		return FluidContainerRegistry.isContainer(player.getHeldItemOffhand());
	}
	...
	public static final boolean isPlayerHoldingNothingOffhand(EntityPlayer player) {

		return player.getHeldItemOffhand() == null;
	}
	...
	public static final boolean isPlayerHoldingItemOffhand(Class<?> item, EntityPlayer player) {

		return item.isInstance(getItemFromStack(player.getHeldItemOffhand()));
	}
	...
	public static final boolean isPlayerHoldingItemOffhand(Item item, EntityPlayer player) {

		return areItemsEqual(item, getItemFromStack(player.getHeldItemOffhand()));
	}
	...
	public static final boolean isPlayerHoldingItemStackOffhand(ItemStack stack, EntityPlayer player) {

		return itemsEqualWithMetadata(stack, player.getHeldItemOffhand());
	}
