...
//Adding methods for offhand stuff. So you could have a battery in the offhand or something. Cos...it's cool.
	public static int extractEnergyFromOffhandContainer(EntityPlayer player, int maxExtract, boolean simulate) {
	...
	public static int insertEnergyIntoOffhandContainer(EntityPlayer player, int maxReceive, boolean simulate) {
	...
	public static boolean isPlayerHoldingOffhandEnergyContainerItem(EntityPlayer player) {
